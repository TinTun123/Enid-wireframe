<template>
    <transition>
        <div :key="courseStore.currentCourseID">
            <div v-if="type === 'desktop'" class="w-full h-[335px] bg-neutral-400 ml-4 rounded-[10px]">
                    ...
                    <div class="m-4 lg-tablet:m-0 lg-tablet:flex lg-tablet:flex-col">
                        ...
                        <div class="lg-tablet:flex">
                            ...
                            <div>
                                <div class="flex items-baseline gap-x-1 mb-1">
                                    ...
                                    <h4 class="text-minor-xxsm text-black/80 tablet:text-minor-xsm lg-tablet:text-base">EXERCISES</h4>
                                </div>

                                <ol class="list-decimal ml-4 mb-3">
                                    <li v-for="(exercise, i) in weeks.exercise" :key="i" class="text-minor-xxsm font-medium text-black/90 tablet:text-minor-xsm tablet:font-medium lg-tablet:text-base">{{exercise}}</li>
                                </ol>
                            </div>
                            ...
                            <div>
                                <div class="flex items-baseline gap-x-1 mb-1">
                                    <div class="w-2 h-2 tablet:w-3 tablet:h-3">
                                        <svg class="w-full h-full" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M3.47209 5.55554C3.47209 6.16942 2.97487 6.66665 2.36099 6.66665C1.7471 6.66665 1.24988 6.16942 1.24988 5.55554C1.24988 4.94165 1.7471 4.44443 2.36099 4.44443C2.97487 4.44443 3.47209 4.94165 3.47209 5.55554Z" fill="black" fill-opacity="0.6"/>
                                            <path d="M-0.00012207 8.48473C-0.00012207 7.64528 1.57293 7.22223 2.36098 7.22223C3.14904 7.22223 4.72209 7.64528 4.72209 8.48473V10H-0.00012207V8.48473Z" fill="black" fill-opacity="0.6"/>
                                            <path d="M8.7498 5.55554C8.7498 6.16942 8.25258 6.66665 7.6387 6.66665C7.02481 6.66665 6.52759 6.16942 6.52759 5.55554C6.52759 4.94165 7.02481 4.44443 7.6387 4.44443C8.25258 4.44443 8.7498 4.94165 8.7498 5.55554Z" fill="black" fill-opacity="0.6"/>
                                            <path d="M6.11101 4.99999C6.11101 5.61388 5.61379 6.1111 4.9999 6.1111C4.38601 6.1111 3.88879 5.61388 3.88879 4.99999C3.88879 4.38611 4.38601 3.88889 4.9999 3.88889C5.61379 3.88889 6.11101 4.38611 6.11101 4.99999Z" fill="black" fill-opacity="0.6"/>
                                            <path d="M4.7221 1.89805C4.7221 1.542 4.58066 1.20053 4.32889 0.948763C4.07712 0.696996 3.73566 0.555555 3.3796 0.555555H2.49933C2.13509 0.554969 1.78521 0.697549 1.52512 0.952554C1.26504 1.20756 1.11559 1.55456 1.10899 1.91874C1.1024 2.28292 1.23918 2.63511 1.48986 2.89937C1.74054 3.16362 2.08503 3.31878 2.44905 3.33138L2.49988 3.33333V3.88888C2.49988 3.88888 4.7221 3.56472 4.7221 1.89805ZM5.55543 1.45444C5.55543 1.0687 5.70867 0.698757 5.98143 0.425996C6.25419 0.153235 6.62413 0 7.00987 0H8.61098C8.97933 0 9.3326 0.146329 9.59307 0.406796C9.85353 0.667262 9.99986 1.02053 9.99986 1.38889C9.99986 1.75724 9.85353 2.11051 9.59307 2.37098C9.3326 2.63144 8.97933 2.77777 8.61098 2.77777H8.05542V3.61111C8.05542 3.61111 5.55543 3.25999 5.55543 1.45444ZM5.27765 8.48471C5.27765 7.64527 6.8507 7.22221 7.63876 7.22221C8.42681 7.22221 9.99986 7.64527 9.99986 8.48471V9.99998H5.27765V8.48471Z" fill="black" fill-opacity="0.6"/>
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M4.99983 7.92915C4.99983 7.6811 5.14538 7.46916 5.37205 7.29388C5.38504 7.28395 5.39819 7.27423 5.41149 7.26471C5.60482 7.12416 5.85038 7.00832 6.11232 6.91749C5.85215 6.79482 5.57365 6.71553 5.28788 6.68277C5.09654 6.66129 4.90339 6.66129 4.71205 6.68277C4.4262 6.71541 4.14761 6.79461 3.88733 6.91721C4.14927 7.00832 4.39483 7.12416 4.58844 7.26443C4.60177 7.27416 4.61455 7.28388 4.62733 7.29388C4.85427 7.46888 4.99983 7.6811 4.99983 7.92915Z" fill="black" fill-opacity="0.6"/>
                                        </svg>
                                    </div>

                                    <h4 class="text-minor-xxsm text-black/80 tablet:text-minor-xsm lg-tablet:text-base">DISCUSSION</h4>
                                </div>

                                <ol class="list-decimal ml-4 mb-3">
                                    <li v-for="(discussion, i) in weeks.discussion" :key="i" class="text-minor-xxsm font-medium text-black/90 tablet:text-minor-xsm tablet:font-medium lg-tablet:text-base">{{ discussion }}</li>
                                </ol>
                            </div>
                        ...
                        <div class="lg-tablet:flex">
                            <div class="flex items-baseline gap-x-1 mb-1">
                                ...
                                <h4 class="text-minor-xxsm text-black/80 tablet:text-minor-xsm lg-tablet:text-base">READING</h4>
                            </div>

                            <ol class="list-decimal ml-4 mb-3">
                                <li v-for="(reading, i) in weeks.readings" :key="i" class="text-minor-xxsm font-medium text-black/90 tablet:text-minor-xsm tablet:font-medium lg-tablet:text-base">{{ reading }}</li>
                            </ol>
                            ...
                            <div class="flex items-baseline gap-x-1 mb-1">
                                ...
                                <h4 class="text-minor-xxsm text-black/80 tablet:text-minor-xsm lg-tablet:text-base">ASSIGNMENTS</h4>
                            </div>

                            <ol class="list-decimal ml-4 mb-3">
                                <li v-for="(assign, i) in weeks.assginments" :key="i" class="text-minor-xxsm font-medium text-black/90 tablet:text-minor-xsm tablet:font-medium lg-tablet:text-base">{{ assign }}</li>
                            </ol>
                        </div>
