    ...
    @click="picked_school"
      ...
      ">
          <div class="text-block">
              <h1 class="text-minor-sm text-school-name font-semibold">
              {{ school.name }}
              </h1>
              <p class="
              text-minor-xxsm 
          ...
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <span class="text-minor-xxsm text-white pr-1 font-semibold">
              More
            </span>
          </a>
          <!-- fill="#5D5D72" school-color -->
          <span class="absolute bottom-[0.125rem] flex items-center right-[0.1975rem] w-4 h-4">
            <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <defs>
                ...
                <rect x="0.203735" y="0.159912" width="16.803" height="16.8995" rx="8.40149" fill="white"/>
                </clipPath>
              </defs>
            </svg>
